...
<body>
    ...
    <script>
        ...
        function loadEventDashboard() {
            ...
            fetch('http://localhost/demo/getseminar.php') // Replace with the actual API endpoint
                .then(response => response.json())
                .then(data => {
                    ...
                    data.forEach(seminar => {
                        ...
                        seminarName.textContent = seminar.title;
