...
<body>
    ...
    <div class="second-third-container">
        <div class="second-part">
            ...
            <ul class="options">
            <li class="option-item" onclick="loadEventDashboard()">Seminar</li>
                <li class="option-item" onclick="loadEventDashboard()">Departments</li>
                <li class="option-item" onclick="loadEventDashboard()">Sports</li>
                <li class="option-item" onclick="loadEventDashboard()">Clubs/Culturals</li>
                <li class="option-item" onclick="loadEventDashboard()">Others</li>
    ...
    <script>
        ...
        function loadEventDashboard() {
            ...
            fetch('http://localhost/demo/getsport.php') // Replace with the actual API endpoint
                .then(response => response.json())
                .then(data => {
                    ...
                    data.forEach(seminar => {
                        ...
                        seminarName.textContent = seminar.Event_Title;
